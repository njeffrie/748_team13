...
*
*******************************************************************************/
//Waits for input from MATLAB and trsnmits the data on receviing input. This was used along with a MATLAB code that continuously sends the input. MATLABinput is required so that the lights are synchronized
...
#define VLC_ADDR	3//Start with 0

// This is the total number of nodes supported
#define TOTAL_NODES	4

#define MSG_SIZE	3 //Freq_ON Freq_OFF Data 
